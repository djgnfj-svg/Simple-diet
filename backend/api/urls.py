...
router.register(r'calc-metabolic', Metabolic_Calc_Viewset, basename="calc-metabolic")
router.register(r'managing-diet', Diet_Managing_Viewset, basename="managing-diet")
